    ...
    <div className="w-full p-4 rounded-xl border border-neutral-300 relative">
      <div className="w-full flex flex-col justify-center items-start gap-4">
        <div className="w-full flex items-center gap-4">
          <div className="w-10 h-10 aspect-square rounded-full bg-neutral-300">
            {avatar ? (
              <img
                src={avatar}
                alt="pp"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 rounded-full hover:cursor-pointer hover:bg-neutral-300"
            >
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            ...
            <input
              ...
              className="w-full border text-zinc-800 border-neutral-500 rounded-lg outline-none p-2 mb-3"
            />
            <div className="flex gap-2 justify-end">
              <button
                onClick={() => setShowModal(false)}
                className="px-4 py-2 border border-neutral-300 text-neutral-700 cursor-pointer rounded-lg"
              >
                Batal
              </button>
              <button
